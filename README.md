...
* [`src/cljs/fracture/`](src/cljs/fracture/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/fracture/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `fracture` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/fracture/config.cljs) defaults to `true` in
...
```clj
(ns fracture.example
  (:require [fracture.config :as config])
